...
const DICT = {
  pl: {
    ...
    'w.privacy': 'Twoje dane zostają na urządzeniu. Pełny opis prywatności znajdziesz w Bibliotece.',
    ...
    'ida.boundJudge': 'Też bym chciała powiedzieć, czy to dobry, czy zły wynik — ale naprawdę tego nie oceniam. To rozmowa z lekarzem, nie z bazą.',
    'ida.boundDecide': 'Decyzje o lekach zostawiam lekarzowi prowadzącemu — to zbyt ważne, żebym zgadywała.',
  ...
  en: {
    ...
    'w.privacy': 'Your data stays on your device. Full privacy details are in the Library.',
    ...
    'ida.boundJudge': 'I wish I could tell you whether that result is good or bad — but I really can\'t. That\'s a conversation for a doctor, not a database.',
    'ida.boundDecide': 'I leave medication decisions to your treating doctor — that\'s too important for me to guess at.',
  ...
  uk: {
    ...
    'w.privacy': 'Твої дані залишаються на пристрої. Повний опис приватності — у Бібліотеці.',
    ...
    'ida.boundJudge': 'Я теж хотіла б сказати, чи це добрий, чи поганий результат — але справді цього не оцінюю. Це розмова з лікарем, а не з базою.',
    'ida.boundDecide': 'Рішення про ліки залишаю лікарю, який тебе веде — це занадто важливо, щоб я вгадувала.',
  ...
  ru: {
    ...
    'w.privacy': 'Твои данные остаются на устройстве. Полное описание приватности — в Библиотеке.',
    ...
    'ida.boundJudge': 'Я тоже хотела бы сказать, хороший это результат или плохой — но правда этого не оцениваю. Это разговор с врачом, а не с базой.',
    'ida.boundDecide': 'Решения о лекарствах оставляю твоему лечащему врачу — это слишком важно, чтобы я гадала.',
...
/* #audyt-4 (R-1a / R-1c): etykiety wiarygodności mówią prawdę o tym, co widać.
 * 1. „społeczność" opisywała rzekomego AUTORA, a nie autorytet źródła — a pod tą plakietką
 *    stoją prasa branżowa, serwis z cenami leków i strony organizacji. Nikt tego nie
 *    „wniósł ze społeczności". Nowa etykieta mówi, jaki to status wiedzy: do potwierdzenia.
 * 2. Blok „granice" to zasada samego Kręgu, nie fakt medyczny — dostaje własną etykietę
 *    zamiast najniższego poziomu wiarygodności (kategoria, nie ocena).
 * 3. Tłumaczenie maszynowe nie dziedziczy autorytetu źródła (R-1c).
 * 4. ida.baseUnverified → ida.base: nazwa klucza przestała pasować do treści po P0-5
 *    (tekst już wcześniej poprawiono na samo „Baza wiedzy"). */
Object.assign(DICT.pl, {"trust.community":"do potwierdzenia","trust.rule":"zasada Kręgu","ida.mt":"Tłumaczenie maszynowe — wiarygodność dotyczy oryginału po polsku.","ida.base":"Baza wiedzy {ed}"});
Object.assign(DICT.en, {"trust.community":"to confirm","trust.rule":"Circle rule","ida.mt":"Machine translation — the reliability rating applies to the Polish original.","ida.base":"Knowledge base {ed}"});
Object.assign(DICT.uk, {"trust.community":"до підтвердження","trust.rule":"правило Кола","ida.mt":"Машинний переклад — оцінка надійності стосується польського оригіналу.","ida.base":"База знань {ed}"});
Object.assign(DICT.ru, {"trust.community":"требует подтверждения","trust.rule":"правило Круга","ida.mt":"Машинный перевод — оценка надёжности относится к польскому оригиналу.","ida.base":"База знаний {ed}"});
Object.assign(DICT.de, {"trust.community":"zu bestätigen","trust.rule":"Regel des Kreises","ida.mt":"Maschinelle Übersetzung — die Verlässlichkeitsangabe gilt für das polnische Original.","ida.base":"Wissensbasis {ed}"});
Object.assign(DICT.cs, {"trust.community":"k potvrzení","trust.rule":"pravidlo Kruhu","ida.mt":"Strojový překlad — hodnocení spolehlivosti se týká polského originálu.","ida.base":"Znalostní báze {ed}"});
Object.assign(DICT.sk, {"trust.community":"na potvrdenie","trust.rule":"pravidlo Kruhu","ida.mt":"Strojový preklad — hodnotenie spoľahlivosti sa týka poľského originálu.","ida.base":"Znalostná báza {ed}"});
Object.assign(DICT.be, {"trust.community":"патрабуе пацвярджэння","trust.rule":"правіла Кола","ida.mt":"Машынны пераклад — ацэнка надзейнасці датычыцца польскага арыгінала.","ida.base":"База ведаў {ed}"});
Object.assign(DICT.lt, {"trust.community":"reikia patvirtinti","trust.rule":"Rato taisyklė","ida.mt":"Mašininis vertimas — patikimumo įvertinimas taikomas lenkiškam originalui.","ida.base":"Žinių bazė {ed}"});

/* #audyt-3 (S-2, faza 2): w pokoju występujesz pod osobną tożsamością. Prawda w miejscu
 * użycia (zasada z audytu #1) — mówimy, przed kim to chroni, i nie obiecujemy więcej. */
Object.assign(DICT.pl, {"room.identNote":"Gdy dołączasz, występujesz pod osobną nazwą — inne osoby nie zobaczą Twojego uchwytu z rozmów. Zakładając pokój, jesteś gospodarzem pod swoją nazwą."});
Object.assign(DICT.en, {"room.identNote":"When you join, you appear under a separate name — others won't see your handle from conversations. If you create a room, you host it under your own name."});
Object.assign(DICT.uk, {"room.identNote":"Коли приєднуєшся, ти виступаєш під окремим імʼям — інші не побачать твого імені з розмов. Створюючи кімнату, ти господар під своїм імʼям."});
Object.assign(DICT.ru, {"room.identNote":"Когда присоединяешься, ты выступаешь под отдельным именем — другие не увидят твоё имя из разговоров. Создавая комнату, ты хозяин под своим именем."});
Object.assign(DICT.de, {"room.identNote":"Wenn du beitrittst, erscheinst du unter einem eigenen Namen — andere sehen dein Kürzel aus den Gesprächen nicht. Erstellst du einen Raum, bist du Gastgeber unter deinem eigenen Namen."});
Object.assign(DICT.cs, {"room.identNote":"Když se připojíš, vystupuješ pod samostatným jménem — ostatní neuvidí tvé jméno z rozhovorů. Když místnost zakládáš, jsi hostitel pod svým jménem."});
Object.assign(DICT.sk, {"room.identNote":"Keď sa pripojíš, vystupuješ pod samostatným menom — ostatní neuvidia tvoje meno z rozhovorov. Keď miestnosť zakladáš, si hostiteľ pod svojím menom."});
Object.assign(DICT.be, {"room.identNote":"Калі далучаешся, ты выступаеш пад асобным імем — іншыя не ўбачаць твайго імя з размоў. Ствараючы пакой, ты гаспадар пад сваім імем."});
Object.assign(DICT.lt, {"room.identNote":"Kai prisijungi, esi matomas atskiru vardu — kiti nematys tavo vardo iš pokalbių. Kurdamas kambarį, esi šeimininkas savo vardu."});

/* #audyt-3 (S-2): pokoje. Katalog podaje PRZEDZIAŁ zamiast dokładnego licznika (dokładna
 * liczba pozwalała obserwować przyrost i wnioskować o czyimś dołączeniu). Klucz wejściowy
 * jest DODATKIEM założyciela — pokoje zostają domyślnie otwarte (decyzja 2026-08-06). */
Object.assign(DICT.pl, {"room.size.empty":"pusto","room.size.few":"kilka osób","room.size.some":"kilkanaście osób","room.size.many":"dużo osób","room.keyed":"na klucz","room.keyedOpt":"Tylko dla osób z kluczem","room.keyedHint":"Pokój nie pojawi się na liście. Wejdą tylko osoby, którym dasz klucz.","room.haveKey":"Mam klucz do pokoju","room.keyPh":"KRAG-POK-…","room.useKey":"Wejdź kluczem","room.needKey":"Wklej klucz.","room.badKey":"Ten klucz nie działa — mógł wygasnąć, zostać zużyty albo odwołany.","room.keyReady":"Klucz do pokoju","room.keyOnce":"Pokazujemy go raz. Przekaż go osobie, którą zapraszasz — najlepiej w szyfrowanej rozmowie.","room.keyCopy":"Kopiuj","room.keyCopied":"Skopiowano"});
Object.assign(DICT.en, {"room.size.empty":"empty","room.size.few":"a few people","room.size.some":"a dozen or so","room.size.many":"many people","room.keyed":"key required","room.keyedOpt":"Only for people with a key","room.keyedHint":"The room won't appear in the list. Only people you give a key to can enter.","room.haveKey":"I have a room key","room.keyPh":"KRAG-POK-…","room.useKey":"Enter with key","room.needKey":"Paste the key.","room.badKey":"This key doesn't work — it may have expired, been used up or revoked.","room.keyReady":"Room key","room.keyOnce":"Shown once. Pass it to the person you're inviting — ideally in an encrypted conversation.","room.keyCopy":"Copy","room.keyCopied":"Copied"});
Object.assign(DICT.uk, {"room.size.empty":"порожньо","room.size.few":"кілька осіб","room.size.some":"понад десять осіб","room.size.many":"багато осіб","room.keyed":"за ключем","room.keyedOpt":"Лише для осіб із ключем","room.keyedHint":"Кімната не зʼявиться у списку. Увійдуть лише ті, кому даси ключ.","room.haveKey":"Маю ключ до кімнати","room.keyPh":"KRAG-POK-…","room.useKey":"Увійти ключем","room.needKey":"Встав ключ.","room.badKey":"Цей ключ не працює — міг сплинути, бути використаним або відкликаним.","room.keyReady":"Ключ до кімнати","room.keyOnce":"Показуємо один раз. Передай його тому, кого запрошуєш — найкраще в зашифрованій розмові.","room.keyCopy":"Копіювати","room.keyCopied":"Скопійовано"});
Object.assign(DICT.ru, {"room.size.empty":"пусто","room.size.few":"несколько человек","room.size.some":"больше десяти человек","room.size.many":"много людей","room.keyed":"по ключу","room.keyedOpt":"Только для тех, у кого есть ключ","room.keyedHint":"Комната не появится в списке. Войдут только те, кому дашь ключ.","room.haveKey":"У меня есть ключ от комнаты","room.keyPh":"KRAG-POK-…","room.useKey":"Войти по ключу","room.needKey":"Вставь ключ.","room.badKey":"Этот ключ не работает — мог истечь, быть использованным или отозванным.","room.keyReady":"Ключ от комнаты","room.keyOnce":"Показываем один раз. Передай его тому, кого приглашаешь — лучше в зашифрованном разговоре.","room.keyCopy":"Копировать","room.keyCopied":"Скопировано"});
Object.assign(DICT.de, {"room.size.empty":"leer","room.size.few":"ein paar Personen","room.size.some":"gut ein Dutzend","room.size.many":"viele Personen","room.keyed":"mit Schlüssel","room.keyedOpt":"Nur für Personen mit Schlüssel","room.keyedHint":"Der Raum erscheint nicht in der Liste. Nur wer einen Schlüssel von dir bekommt, kommt hinein.","room.haveKey":"Ich habe einen Raumschlüssel","room.keyPh":"KRAG-POK-…","room.useKey":"Mit Schlüssel eintreten","room.needKey":"Füge den Schlüssel ein.","room.badKey":"Dieser Schlüssel funktioniert nicht — er ist abgelaufen, aufgebraucht oder zurückgezogen.","room.keyReady":"Raumschlüssel","room.keyOnce":"Wird einmal angezeigt. Gib ihn der eingeladenen Person weiter — am besten in einem verschlüsselten Gespräch.","room.keyCopy":"Kopieren","room.keyCopied":"Kopiert"});
Object.assign(DICT.cs, {"room.size.empty":"prázdno","room.size.few":"pár lidí","room.size.some":"něco přes deset lidí","room.size.many":"hodně lidí","room.keyed":"na klíč","room.keyedOpt":"Jen pro lidi s klíčem","room.keyedHint":"Místnost se neobjeví v seznamu. Vejdou jen ti, komu dáš klíč.","room.haveKey":"Mám klíč do místnosti","room.keyPh":"KRAG-POK-…","room.useKey":"Vejít s klíčem","room.needKey":"Vlož klíč.","room.badKey":"Tento klíč nefunguje — mohl vypršet, být vyčerpán nebo odvolán.","room.keyReady":"Klíč do místnosti","room.keyOnce":"Ukazujeme jednou. Předej ho tomu, koho zveš — nejlépe v šifrovaném rozhovoru.","room.keyCopy":"Kopírovat","room.keyCopied":"Zkopírováno"});
Object.assign(DICT.sk, {"room.size.empty":"prázdno","room.size.few":"zopár ľudí","room.size.some":"vyše desať ľudí","room.size.many":"veľa ľudí","room.keyed":"na kľúč","room.keyedOpt":"Len pre ľudí s kľúčom","room.keyedHint":"Miestnosť sa neobjaví v zozname. Vojdú len tí, komu dáš kľúč.","room.haveKey":"Mám kľúč do miestnosti","room.keyPh":"KRAG-POK-…","room.useKey":"Vojsť s kľúčom","room.needKey":"Vlož kľúč.","room.badKey":"Tento kľúč nefunguje — mohol vypršať, byť vyčerpaný alebo odvolaný.","room.keyReady":"Kľúč do miestnosti","room.keyOnce":"Ukazujeme raz. Odovzdaj ho tomu, koho pozývaš — najlepšie v šifrovanom rozhovore.","room.keyCopy":"Kopírovať","room.keyCopied":"Skopírované"});
Object.assign(DICT.be, {"room.size.empty":"пуста","room.size.few":"некалькі чалавек","room.size.some":"больш за дзесяць чалавек","room.size.many":"шмат людзей","room.keyed":"па ключы","room.keyedOpt":"Толькі для тых, хто мае ключ","room.keyedHint":"Пакой не зʼявіцца ў спісе. Увойдуць толькі тыя, каму дасі ключ.","room.haveKey":"У мяне ёсць ключ да пакоя","room.keyPh":"KRAG-POK-…","room.useKey":"Увайсці ключом","room.needKey":"Устаў ключ.","room.badKey":"Гэты ключ не працуе — мог скончыцца, быць выкарыстаным ці адкліканым.","room.keyReady":"Ключ да пакоя","room.keyOnce":"Паказваем адзін раз. Перадай яго таму, каго запрашаеш — найлепш у зашыфраванай размове.","room.keyCopy":"Скапіяваць","room.keyCopied":"Скапіявана"});
Object.assign(DICT.lt, {"room.size.empty":"tuščia","room.size.few":"keli žmonės","room.size.some":"daugiau nei dešimt žmonių","room.size.many":"daug žmonių","room.keyed":"su raktu","room.keyedOpt":"Tik žmonėms su raktu","room.keyedHint":"Kambarys nepasirodys sąraše. Įeis tik tie, kuriems duosi raktą.","room.haveKey":"Turiu kambario raktą","room.keyPh":"KRAG-POK-…","room.useKey":"Įeiti su raktu","room.needKey":"Įklijuok raktą.","room.badKey":"Šis raktas neveikia — galėjo baigtis galiojimas, būti panaudotas arba atšauktas.","room.keyReady":"Kambario raktas","room.keyOnce":"Rodome vieną kartą. Perduok jį tam, ką kvieti — geriausia šifruotame pokalbyje.","room.keyCopy":"Kopijuoti","room.keyCopied":"Nukopijuota"});

// #audyt-2 (K-3): granica wyrobu medycznego doprecyzowana — 'trend' (dzielenie się wynikiem,
// bez pytania o ocenę/decyzję) dostaje ciepłą odpowiedź trenerki; 'judge'/'decide' zostają
// twardym stopem, ale z cieplejszym wprowadzeniem niż poprzednio. de/cs/sk/be/lt: uzupełnienie
// ida.boundJudge/ida.boundDecide (stary klucz ida.bound w blobach zostaje, nieużywany).
Object.assign(DICT.pl, {"ida.trendReply":"Fajnie, że wracasz z aktualizacją i regularnie się sprawdzasz — to się liczy, niezależnie od tego, jaka to liczba. Samej liczby nie oceniam, ale mogę pomóc to zapisać.","ida.trendDiary":"Otwórz dzienniczek"});
Object.assign(DICT.en, {"ida.trendReply":"Good to see you checking in and coming back with an update — that matters, whatever the number is. I won't grade the number itself, but I can help you log it.","ida.trendDiary":"Open the diary"});
Object.assign(DICT.uk, {"ida.trendReply":"Добре, що ти повертаєшся з оновленням і регулярно перевіряєшся — це має значення, яким би не було число. Саму цифру не оцінюю, але можу допомогти це записати.","ida.trendDiary":"Відкрити щоденник"});
Object.assign(DICT.ru, {"ida.trendReply":"Хорошо, что ты возвращаешься с обновлением и регулярно проверяешься — это важно, какой бы ни была цифра. Саму цифру не оцениваю, но могу помочь это записать.","ida.trendDiary":"Открыть дневник"});
Object.assign(DICT.de, {"ida.trendReply":"Schön, dass du mit einem Update zurückkommst und dich regelmäßig checkst — das zählt, egal wie die Zahl aussieht. Die Zahl selbst bewerte ich nicht, aber ich kann dir helfen, sie einzutragen.","ida.trendDiary":"Tagebuch öffnen","ida.boundJudge":"Ich würde auch gerne sagen, ob das Ergebnis gut oder schlecht ist — aber das kann ich wirklich nicht beurteilen. Das ist ein Gespräch für einen Arzt, keine Datenbank.","ida.boundDecide":"Entscheidungen über Medikamente überlasse ich deinem behandelnden Arzt — das ist zu wichtig, um es zu raten."});
Object.assign(DICT.cs, {"ida.trendReply":"Fajn, že se vracíš s aktualizací a pravidelně se kontroluješ — na tom záleží, ať je číslo jakékoli. Samotné číslo nehodnotím, ale mohu ti pomoct ho zapsat.","ida.trendDiary":"Otevřít deník","ida.boundJudge":"Taky bych ráda řekla, jestli je ten výsledek dobrý, nebo špatný — ale to opravdu nedokážu posoudit. To je rozhovor pro lékaře, ne pro databázi.","ida.boundDecide":"Rozhodnutí o lécích nechávám na tvém ošetřujícím lékaři — je to příliš důležité na to, abych hádala."});
Object.assign(DICT.sk, {"ida.trendReply":"Fajn, že sa vraciaš s aktualizáciou a pravidelne sa kontroluješ — na tom záleží, nech je číslo akékoľvek. Samotné číslo nehodnotím, ale môžem ti pomôcť ho zapísať.","ida.trendDiary":"Otvoriť denník","ida.boundJudge":"Aj ja by som rada povedala, či je ten výsledok dobrý, alebo zlý — ale to naozaj nedokážem posúdiť. To je rozhovor pre lekára, nie pre databázu.","ida.boundDecide":"Rozhodnutia o liekoch nechávam na tvojom ošetrujúcom lekárovi — je to príliš dôležité na to, aby som hádala."});
Object.assign(DICT.be, {"ida.trendReply":"Файна, што ты вяртаешся з абнаўленнем і рэгулярна правяраешся — гэта мае значэнне, якім бы ні было лічба. Саму лічбу не ацэньваю, але магу дапамагчы гэта запісаць.","ida.trendDiary":"Адкрыць дзённік","ida.boundJudge":"Я таксама хацела б сказаць, добры гэта вынік ці дрэнны — але сапраўды гэтага не ацэньваю. Гэта размова з лекарам, а не з базай.","ida.boundDecide":"Рашэнні пра лекі пакідаю тваму лекару — гэта занадта важна, каб я гадала."});
Object.assign(DICT.lt, {"ida.trendReply":"Smagu, kad grįžti su atnaujinimu ir reguliariai tikriniesi — tai svarbu, koks bebūtų skaičius. Pačio skaičiaus nevertinu, bet galiu padėti jį užsirašyti.","ida.trendDiary":"Atidaryti dienoraštį","ida.boundJudge":"Aš irgi norėčiau pasakyti, ar rezultatas geras, ar blogas — bet to tikrai negaliu įvertinti. Tai pokalbis su gydytoju, ne su duomenų baze.","ida.boundDecide":"Sprendimus dėl vaistų palieku tavo gydančiam gydytojui — tai per daug svarbu, kad spėčiau."});

// #audyt-1: prawda w UI — krótka linijka na wejściu (sąsiedzi); pełny opis w Bibliotece
Object.assign(DICT.de, {"w.privacy":"Deine Daten bleiben auf deinem Gerät. Die vollständigen Datenschutzhinweise findest du in der Bibliothek."});
Object.assign(DICT.cs, {"w.privacy":"Tvoje data zůstávají v tvém zařízení. Úplné informace o soukromí najdeš v Knihovně."});
Object.assign(DICT.sk, {"w.privacy":"Tvoje dáta zostávajú v tvojom zariadení. Úplné informácie o súkromí nájdeš v Knižnici."});
Object.assign(DICT.be, {"w.privacy":"Твае дадзеныя застаюцца на тваёй прыладзе. Поўнае апісанне прыватнасці — у Бібліятэцы."});
Object.assign(DICT.lt, {"w.privacy":"Tavo duomenys lieka tavo įrenginyje. Visą privatumo aprašymą rasi Bibliotekoje."});

// #audyt-1: strona „Prywatność w Kręgu" w Bibliotece — pełny, uczciwy opis (bez plakietek zaufania)
Object.assign(DICT.pl, {"lib.privacy":"Prywatność w Kręgu","lib.privacyLead":"Co zostaje na urządzeniu, a co wysyłamy, gdy pytasz Idę.","priv.title":"Prywatność w Kręgu","priv.body":"<p>Krąg jest zbudowany tak, aby to, co dotyczy Twojego zdrowia i tożsamości, zostawało na Twoim urządzeniu.</p><p><strong>Co zostaje u Ciebie.</strong> Dziennik, wyniki, leki, notatki, Twoja nazwa i klucze zapisują się zaszyfrowane w pamięci tej przeglądarki (IndexedDB). Nie wysyłamy tego nigdzie — nie mamy do tego dostępu i nie umiemy tego odzyskać za Ciebie.</p><p><strong>Gdy pytasz Idę.</strong> Żeby odpowiedzieć sensownie, wysyłamy na nasz serwer treść Twojego pytania, kilka ostatnich wiadomości z tej rozmowy i pasujące fakty z bazy Kręgu. Nie wysyłamy dziennika, wyników, Twojej nazwy ani kluczy. Pytanie idzie anonimowo, a Ida odpowiada wyłącznie z faktów Kręgu.</p><p><strong>Wiadomości do innych.</strong> To, co piszesz do ludzi w Kręgu, jest szyfrowane — czytają je tylko rozmówcy.</p><p><strong>Czego nie robimy.</strong> Bez reklam, bez śledzenia, bez profilowania, bez sprzedawania danych. Nikomu.</p><p><strong>Ty decydujesz.</strong> W każdej chwili możesz usunąć wszystko z tego urządzenia. Krąg działa też offline.</p>"});
Object.assign(DICT.en, {"lib.privacy":"Privacy in the Circle","lib.privacyLead":"What stays on your device, and what we send when you ask Ida.","priv.title":"Privacy in the Circle","priv.body":"<p>Krąg is built so that what concerns your health and identity stays on your device.</p><p><strong>What stays with you.</strong> Your diary, results, medications, notes, your name and keys are stored encrypted in this browser (IndexedDB). We don't send it anywhere — we can't see it and can't recover it for you.</p><p><strong>When you ask Ida.</strong> To answer properly, we send our server the text of your question, the last few messages in this conversation, and matching facts from the Circle's knowledge base. We don't send your diary, results, name or keys. The question goes anonymously, and Ida answers only from Circle facts.</p><p><strong>Messages to others.</strong> What you write to people in the Circle is encrypted — only the people in the conversation can read it.</p><p><strong>What we don't do.</strong> No ads, no tracking, no profiling, no selling data. To anyone.</p><p><strong>You're in control.</strong> You can delete everything from this device at any time. Krąg also works offline.</p>"});
Object.assign(DICT.uk, {"lib.privacy":"Приватність у Krąg","lib.privacyLead":"Що залишається на твоєму пристрої, а що ми надсилаємо, коли ти запитуєш Ida.","priv.title":"Приватність у Krąg","priv.body":"<p>Krąg побудований так, щоб те, що стосується твого здоров'я та ідентичності, залишалося на твоєму пристрої.</p><p><strong>Що залишається в тебе.</strong> Щоденник, результати, ліки, нотатки, твоє ім'я та ключі зберігаються зашифрованими в пам'яті цього браузера (IndexedDB). Ми нікуди це не надсилаємо — ми не маємо до цього доступу і не можемо відновити це за тебе.</p><p><strong>Коли ти запитуєш Ida.</strong> Щоб відповісти доречно, ми надсилаємо на наш сервер текст твого запитання, кілька останніх повідомлень з цієї розмови та відповідні факти з бази Krąg. Ми не надсилаємо щоденник, результати, твоє ім'я чи ключі. Запитання йде анонімно, а Ida відповідає лише з фактів Krąg.</p><p><strong>Повідомлення іншим.</strong> Те, що ти пишеш людям у Krąg, зашифроване — читають це лише співрозмовники.</p><p><strong>Чого ми не робимо.</strong> Без реклами, без стеження, без профілювання, без продажу даних. Нікому.</p><p><strong>Ти вирішуєш.</strong> Будь-якої миті ти можеш видалити все з цього пристрою. Krąg працює також офлайн.</p>"});
Object.assign(DICT.ru, {"lib.privacy":"Приватность в Krąg","lib.privacyLead":"Что остаётся на твоём устройстве, а что мы отправляем, когда ты спрашиваешь Ida.","priv.title":"Приватность в Krąg","priv.body":"<p>Krąg устроен так, чтобы то, что касается твоего здоровья и личности, оставалось на твоём устройстве.</p><p><strong>Что остаётся у тебя.</strong> Дневник, результаты, лекарства, заметки, твоё имя и ключи хранятся зашифрованными в памяти этого браузера (IndexedDB). Мы никуда это не отправляем — у нас нет к этому доступа, и мы не можем восстановить это за тебя.</p><p><strong>Когда ты спрашиваешь Ida.</strong> Чтобы ответить по существу, мы отправляем на наш сервер текст твоего вопроса, несколько последних сообщений из этого разговора и подходящие факты из базы Krąg. Мы не отправляем дневник, результаты, твоё имя или ключи. Вопрос идёт анонимно, а Ida отвечает только из фактов Krąg.</p><p><strong>Сообщения другим.</strong> То, что ты пишешь людям в Krąg, зашифровано — читают это только собеседники.</p><p><strong>Чего мы не делаем.</strong> Без рекламы, без слежки, без профилирования, без продажи данных. Никому.</p><p><strong>Ты решаешь.</strong> В любой момент ты можешь удалить всё с этого устройства. Krąg работает и офлайн.</p>"});
Object.assign(DICT.de, {"lib.privacy":"Privatsphäre in Krąg","lib.privacyLead":"Was auf deinem Gerät bleibt und was wir senden, wenn du Ida fragst.","priv.title":"Privatsphäre in Krąg","priv.body":"<p>Krąg ist so gebaut, dass das, was deine Gesundheit und Identität betrifft, auf deinem Gerät bleibt.</p><p><strong>Was bei dir bleibt.</strong> Tagebuch, Ergebnisse, Medikamente, Notizen, dein Name und deine Schlüssel werden verschlüsselt im Speicher dieses Browsers (IndexedDB) abgelegt. Wir senden das nirgendwohin — wir haben keinen Zugriff darauf und können es nicht für dich wiederherstellen.</p><p><strong>Wenn du Ida fragst.</strong> Um sinnvoll zu antworten, senden wir an unseren Server den Text deiner Frage, die letzten paar Nachrichten aus diesem Gespräch und passende Fakten aus der Wissensbasis von Krąg. Wir senden weder Tagebuch, Ergebnisse, deinen Namen noch Schlüssel. Die Frage geht anonym, und Ida antwortet ausschließlich aus den Fakten von Krąg.</p><p><strong>Nachrichten an andere.</strong> Was du an Menschen in Krąg schreibst, ist verschlüsselt — lesen können es nur die Gesprächspartner.</p><p><strong>Was wir nicht tun.</strong> Keine Werbung, kein Tracking, kein Profiling, kein Verkauf von Daten. An niemanden.</p><p><strong>Du entscheidest.</strong> Du kannst jederzeit alles von diesem Gerät löschen. Krąg funktioniert auch offline.</p>"});
Object.assign(DICT.cs, {"lib.privacy":"Soukromí v Krąg","lib.privacyLead":"Co zůstává na tvém zařízení a co posíláme, když se ptáš Ida.","priv.title":"Soukromí v Krąg","priv.body":"<p>Krąg je postaven tak, aby to, co se týká tvého zdraví a identity, zůstávalo na tvém zařízení.</p><p><strong>Co zůstává u tebe.</strong> Deník, výsledky, léky, poznámky, tvé jméno a klíče se ukládají zašifrované v paměti tohoto prohlížeče (IndexedDB). Nikam to neposíláme — nemáme k tomu přístup a neumíme to za tebe obnovit.</p><p><strong>Když se ptáš Ida.</strong> Abychom odpověděli smysluplně, posíláme na náš server text tvé otázky, několik posledních zpráv z tohoto rozhovoru a odpovídající fakta z databáze Krąg. Neposíláme deník, výsledky, tvé jméno ani klíče. Otázka jde anonymně a Ida odpovídá výhradně z faktů Krąg.</p><p><strong>Zprávy ostatním.</strong> To, co píšeš lidem v Krąg, je šifrované — čtou to jen účastníci rozhovoru.</p><p><strong>Co neděláme.</strong> Žádné reklamy, žádné sledování, žádné profilování, žádný prodej dat. Nikomu.</p><p><strong>Ty rozhoduješ.</strong> Kdykoli můžeš smazat vše z tohoto zařízení. Krąg funguje i offline.</p>"});
Object.assign(DICT.sk, {"lib.privacy":"Súkromie v Krąg","lib.privacyLead":"Čo zostáva na tvojom zariadení a čo posielame, keď sa pýtaš Ida.","priv.title":"Súkromie v Krąg","priv.body":"<p>Krąg je postavený tak, aby to, čo sa týka tvojho zdravia a identity, zostávalo na tvojom zariadení.</p><p><strong>Čo zostáva u teba.</strong> Denník, výsledky, lieky, poznámky, tvoje meno a kľúče sa ukladajú zašifrované v pamäti tohto prehliadača (IndexedDB). Nikam to neposielame — nemáme k tomu prístup a nevieme to za teba obnoviť.</p><p><strong>Keď sa pýtaš Ida.</strong> Aby sme odpovedali zmysluplne, posielame na náš server text tvojej otázky, niekoľko posledných správ z tohto rozhovoru a zodpovedajúce fakty z databázy Krąg. Neposielame denník, výsledky, tvoje meno ani kľúče. Otázka ide anonymne a Ida odpovedá výhradne z faktov Krąg.</p><p><strong>Správy ostatným.</strong> To, čo píšeš ľuďom v Krąg, je šifrované — čítajú to len účastníci rozhovoru.</p><p><strong>Čo nerobíme.</strong> Žiadne reklamy, žiadne sledovanie, žiadne profilovanie, žiadny predaj dát. Nikomu.</p><p><strong>Ty rozhoduješ.</strong> Kedykoľvek môžeš vymazať všetko z tohto zariadenia. Krąg funguje aj offline.</p>"});
Object.assign(DICT.be, {"lib.privacy":"Прыватнасць у Krąg","lib.privacyLead":"Што застаецца на тваёй прыладзе, а што мы адпраўляем, калі ты пытаешся ў Ida.","priv.title":"Прыватнасць у Krąg","priv.body":"<p>Krąg пабудаваны так, каб тое, што датычыцца твайго здароўя і ідэнтычнасці, заставалася на тваёй прыладзе.</p><p><strong>Што застаецца ў цябе.</strong> Дзённік, вынікі, лекі, нататкі, тваё імя і ключы захоўваюцца зашыфраванымі ў памяці гэтага браўзера (IndexedDB). Мы нікуды гэта не адпраўляем — мы не маем да гэтага доступу і не можам аднавіць гэта за цябе.</p><p><strong>Калі ты пытаешся ў Ida.</strong> Каб адказаць змястоўна, мы адпраўляем на наш сервер тэкст твайго пытання, некалькі апошніх паведамленняў з гэтай размовы і адпаведныя факты з базы Krąg. Мы не адпраўляем дзённік, вынікі, тваё імя ці ключы. Пытанне ідзе ананімна, а Ida адказвае выключна з фактаў Krąg.</p><p><strong>Паведамленні іншым.</strong> Тое, што ты пішаш людзям у Krąg, зашыфравана — чытаюць гэта толькі суразмоўцы.</p><p><strong>Чаго мы не робім.</strong> Без рэкламы, без сачэння, без прафілявання, без продажу даных. Нікому.</p><p><strong>Ты вырашаеш.</strong> У любы момант ты можаш выдаліць усё з гэтай прылады. Krąg працуе і афлайн.</p>"});
Object.assign(DICT.lt, {"lib.privacy":"Privatumas Krąg","lib.privacyLead":"Kas lieka tavo įrenginyje ir ką siunčiame, kai klausi Ida.","priv.title":"Privatumas Krąg","priv.body":"<p>Krąg sukurtas taip, kad tai, kas susiję su tavo sveikata ir tapatybe, liktų tavo įrenginyje.</p><p><strong>Kas lieka pas tave.</strong> Dienoraštis, rezultatai, vaistai, užrašai, tavo vardas ir raktai saugomi užšifruoti šios naršyklės atmintyje (IndexedDB). Mes niekur to nesiunčiame — neturime prie to prieigos ir negalime to tau atkurti.</p><p><strong>Kai klausi Ida.</strong> Kad atsakytume prasmingai, siunčiame į mūsų serverį tavo klausimo tekstą, kelias paskutines šio pokalbio žinutes ir tinkamus faktus iš Krąg žinių bazės. Nesiunčiame dienoraščio, rezultatų, tavo vardo ar raktų. Klausimas keliauja anonimiškai, o Ida atsako tik iš Krąg faktų.</p><p><strong>Žinutės kitiems.</strong> Tai, ką rašai žmonėms Krąg, yra užšifruota — perskaityti gali tik pašnekovai.</p><p><strong>Ko mes nedarome.</strong> Jokios reklamos, jokio sekimo, jokio profiliavimo, jokio duomenų pardavimo. Niekam.</p><p><strong>Tu sprendi.</strong> Bet kada gali ištrinti viską iš šio įrenginio. Krąg veikia ir neprisijungus.</p>"});
