...
const DICT = {
  pl: {
    ...
    'app.empty': 'Nie masz jeszcze rozmów. Poznaj kogoś, kto rozumie — zacznij od katalogu albo pokoju.',
    'app.newConvo': 'Nowa rozmowa',
    'app.discover': 'Poznaj ludzi',
  ...
  en: {
    ...
    'app.empty': 'No conversations yet. Meet someone who gets it — start with the directory or a room.',
    'app.newConvo': 'New conversation',
    'app.discover': 'Meet people',
  ...
  uk: {
    ...
    'app.empty': 'Розмов ще немає. Знайди когось, хто розуміє — почни з каталогу або кімнати.',
    'app.newConvo': 'Нова розмова',
    'app.discover': 'Знайди людей',
  ...
  ru: {
    ...
    'app.empty': 'Разговоров пока нет. Найди того, кто понимает — начни с каталога или комнаты.',
    'app.newConvo': 'Новый разговор',
    'app.discover': 'Найди людей',
