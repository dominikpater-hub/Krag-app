...
const DICT = {
  pl: {
    ...
    'w.b4': 'Poznać ludzi, którzy przechodzą przez to samo — i porozmawiać',
  ...
  en: {
    ...
    'w.b4': 'Meet people going through the same — and talk',
  ...
  uk: {
    ...
    'w.b4': 'Знайти людей, які проходять через те саме — і поговорити',
  ...
  ru: {
    ...
    'w.b4': 'Найти людей, которые проходят через то же — и поговорить',
