...
// #5: interakcje żyją teraz w Bibliotece — odświeżenie na podstawie leków z Dziennika.
export async function refreshInteractions() { renderInteractions(await all('diary')); }
