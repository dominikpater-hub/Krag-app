...
const ALIAS = {
  ...
  przebieg: ['cd4', 'wiremi', 'nadir', 'aids', 'oportunistyczn', 'co znaczy cd4', 'poziom cd4', 'moja odpornosc', 'limfocyt', 'wynik cd4', 'wiremia rosnie', 'wiremia spada'],
  ...
  bezpieczenstwo: ['niskie cd4', 'niskim cd4', 'przy niskim', 'nisko cd4', 'ponizej 200', 'ponizej 100', 'ponizej 50', 'profilaktyka pcp', 'pneumocyst', 'toksoplazmoz', 'oportunistyczne zakazen', 'czy to niebezpieczne przy niskim', 'na co uwazac', 'czego unikac', 'higien', 'surowe mieso', 'zwierze w domu', 'kot w domu', 'iris', 'pogorszenie po starcie'],
