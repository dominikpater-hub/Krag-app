...
const ALIAS = {
  ...
  'koinf-hcv': ['hcv', 'wzw c', 'zapalenie watroby typu c', 'wirusowe zapalenie watroby c', 'watrob', 'zoltaczka', 'marskosc', 'daa', 'wylecze watrobe', 'wyleczyc watrobe', 'wyleczylem hcv', 'wyleczenie hcv', 'po wyleczeniu hcv', 'wyleczyc hcv', 'leczenie watroby', 'leki na watrobe', 'z watroba'],
  ...
  odbudowa: ['odbudow', 'czy cd4 wroci', 'cd4 wraca', 'wraca do normy', 'czy cd4 urosnie', 'czy odpornosc wroci', 'ile trwa odbudowa', 'cd4 nie rosnie', 'cd4 stoi', 'podniesc cd4', 'podniesieni', 'zwiekszyc cd4', 'poprawic cd4', 'czy warto podnosic', 'po co podnosic', 'zaczynalem z niskim', 'zaczynalam z niskim', 'startowalem z niskim', 'zaczynalem od', 'najnizsze cd4', 'mialem bardzo niskie', 'poprawa odpornosci', 'rekonstytucj'],
