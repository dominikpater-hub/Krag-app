 ...
 *
 * 2026-08-07: lista była za krótka i miała dziurę o realnej wadze. Brakowało w niej „PEP" —
 * czyli zapytanie „potrzebuję pep" traciło jedyne słowo, które coś znaczy, i lądowało
 * w bloku o drogach zakażenia zamiast w instrukcji, co robić w ciągu najbliższych godzin.
 * Tak samo ginęły „CD4", „ARV" i „PKD". Filtr długości ma odsiewać szum („nie", „czy", „to"),
 * a nie skróty, wokół których zbudowana jest cała dziedzina.
 *
 * Świadomie NIE dodajemy „HIV": występuje w prawie każdym fakcie, więc niczego nie rozróżnia,
 * a dołożyłby płaski szum do punktacji. Świadomie NIE dodajemy „ART": w polszczyźnie to
 * „art. 161", czyli słowo z zupełnie innego bloku. */
export const ACR = {
  hpv: 1, hcv: 1, hbv: 1, hav: 1, hsv: 1, ebv: 1, wzw: 1, cmv: 1, sti: 1, std: 1, tbc: 1,
  pep: 1, cd4: 1, cd8: 1, pkd: 1, arv: 1, pcp: 1, mac: 1, daa: 1,
};
