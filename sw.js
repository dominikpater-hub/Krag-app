...
const SHELL = ['./','./index.html','./style.css','./app.js','./config.js',
  ...
  './lib/invite.js','./lib/rooms.js','./lib/ocr.js','./lib/emotion.js','./lib/backup.js','./lib/demo-seed.js','./lib/db.js','./lib/dom.js','./lib/nav.js','./lib/diary.js'];
